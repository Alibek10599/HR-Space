...
export interface FormateApplicationRequest {
    appId: number;
    formateId: number;
}

export interface FormateApplicationResponse {
    message: string;
}
...
export interface HrServiceClient {
    ...
    formateApplication(
        request: FormateApplicationRequest,
    ): Observable<FormateApplicationResponse>;
}
...
export interface HrServiceController {
    ...
    formateApplication(
        ...
        | Promise<FormateApplicationResponse>
        | Observable<FormateApplicationResponse>
