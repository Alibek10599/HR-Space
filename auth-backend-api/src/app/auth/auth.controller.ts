...
import { SetPasswordRequest } from 'src/app/grpc/auth.pb';
...
export class AuthController {
  ...
  async setPassword(@Body() setPasswordDto: SetPasswordRequest) {
    await this.authService.setPassword(setPasswordDto);
    return { message: 'Пароль создан. Проверьте почту' };
  }
}
