...
export interface AuthServiceController {
  ...
  reset(request: ResetRequest): Promise<ResetResponse> | Observable<ResetResponse> | ResetResponse;

  createRole(request: RoleRequest): Promise<RoleResponse> | Observable<RoleResponse> | RoleResponse;

  listRoles(request: Empty): Promise<ListRolesResponse> | Observable<ListRolesResponse> | ListRolesResponse;

  setPassword(request: SetPasswordRequest): Promise<ResetResponse> | Observable<ResetResponse> | ResetResponse;
}
